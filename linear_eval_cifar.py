...
parser.add_argument('--pretrained', default='./exp/vicreg_cifar10_1024/model_final.pth', type=str, help='path to pretrained checkpoint')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model, _ = get_backbone(args.arch, args.num_cls)
